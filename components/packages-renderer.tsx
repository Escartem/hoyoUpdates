...
export default function PackagesRenderer({packages, version, sophon}: {packages: any, version: string, sophon?: boolean}) {
    ...
    return (
        <>
            ...
            {sophon && (
                <>
                    <span>This is a sophon package, in order to download the files, please use <a className="underline" href="https://github.com/Escartem/MeiBrowser">MeiBrowser</a> (✿◡‿◡)</span>
                </>
            )}
